...
export function buildValidateMatchMessages(payload) {
  ...
  const gradeLine = projectSpec?.gradeLevel === 'primary' ? '小学（剔除超龄/大学节点）' : '';
...
6. 不要编造新的课内节点名称；未在列表中的名称不得写入 knowledgeNames。
  ...
  "projectPhases": [
    {
      ...
      "deliverable": "阶段产出",
      "literacy": {"knowledge":"","method":"","ability":"","attitude":"","emotion":"","values":""}
    }
  ],
