...
SUBJECT_VALUES: dict[str, dict[str, Any]] = {
    ...
    "politics": {
        "guidance": "义务教育道德与法治课程标准（2022年版）",
        "core_competencies": ["政治认同", "道德修养", "法治观念", "健全人格", "责任意识"],
        "key_themes": ["道德修养", "生命安全与健康", "法治启蒙", "中华优秀传统文化", "国情教育"],
    },
    "psychology": {
        "guidance": "中小学心理健康教育指导纲要（2012年修订）",
        "core_competencies": ["自我认识", "情绪管理", "人际交往", "学习适应", "生活适应"],
        "key_themes": ["认识自我", "学会学习", "人际交往", "情绪调适", "生活适应"],
    },
    "info-tech": {
        "guidance": "信息科技课程标准",
...
def build_subject_errors(subject: str) -> list[dict[str, Any]]:
    common = {
        ...
        "politics": ("只记口号不联系生活情境", "忽视规则意识与法治观念的培养"),
        "psychology": ("把心理教育当成说教", "忽视学生情绪体验与个体差异"),
