#!/usr/bin/env python3
import sys, os
os.chdir('/root/.openclaw/workspace/teachany-courseware/community/sci-e-weather-observation')
...
for name, text in segments:
    out = f'/root/.openclaw/workspace/teachany-courseware/community/sci-e-weather-observation/assets/tts/{name}.mp3'
